...
public class AgentesCombinacao extends Agentes{
   ...
   //CombinacaoAleat1 
   public HeuristicaConstrutivaInicial.Solucao TotalmenteAleatorioSolucao(HeuristicaConstrutivaInicial.Solucao solution_memoria){
   ...
   //CombinacaoAleat2
   public HeuristicaConstrutivaInicial.Solucao AleatorioPior(HeuristicaConstrutivaInicial.Solucao solution_memoria){
   ...
   //CombinacaoAleat3
   public HeuristicaConstrutivaInicial.Solucao AleatorioMelhor(HeuristicaConstrutivaInicial.Solucao solution_memoria){
   ...
   //CombinacaoAleat4
   public HeuristicaConstrutivaInicial.Solucao Melhor_Dois(HeuristicaConstrutivaInicial.Solucao solution_memoria){
   ...
   //CombinacaoAleat5
   public HeuristicaConstrutivaInicial.Solucao Melhor_Pior(HeuristicaConstrutivaInicial.Solucao solution_memoria){
   ...
   //CombinacaoMelhor_S1
   public HeuristicaConstrutivaInicial.Solucao MelhorSol_Aleatorio(HeuristicaConstrutivaInicial.Solucao solution_memoria){
   ...
   public HeuristicaConstrutivaInicial.Solucao MelhorSol_MelhorIndividuo(HeuristicaConstrutivaInicial.Solucao solution_memoria){
   ...
   public HeuristicaConstrutivaInicial.Solucao AleatorioMelhorS(HeuristicaConstrutivaInicial.Solucao solution_memoria){
   ...
   public HeuristicaConstrutivaInicial.Solucao MelhorSol_Melhor_DoisIndv(HeuristicaConstrutivaInicial.Solucao solution_memoria){
   ...
   public HeuristicaConstrutivaInicial.Solucao MelhorSol_Maior_MenorIndv(HeuristicaConstrutivaInicial.Solucao solution_memoria){
