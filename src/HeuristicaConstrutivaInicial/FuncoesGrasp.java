...
public class FuncoesGrasp{
    ...
    public static Dimensao2D lerArq() throws FileNotFoundException,IOException{
               
        //File arq = new File("/home/marianny/Documentos/Mestrado/BWMV/BWMV/Instancia_1_60_4_24.txt");
        File arq = new File("/home/marianny/Documentos/Mestrado/ProjetoA-Team/projetoa-team/testeComplemento.txt");
        ...
        String p1 = resultado[0].trim();
        String p2 = resultado[1].trim();

        for(int si=0;si<p1.length();si++){
            if(p1.charAt(si)== '.'){
                p1 = p1.substring(0, si);
            }
        }
        for(int si=0;si<p2.length();si++){
            if(p2.charAt(si)== '.'){
                p2 = p2.substring(0, si);
            }
        }
        
        int larguraPlaca = Integer.valueOf(p1);
        int alturaPlaca  = Integer.valueOf(p2);
            
        Dimensao2D placa = new Dimensao2D(larguraPlaca, alturaPlaca);   
        return placa;
    }
            ...
            while ((linha = bufferedreader.readLine()) != null){
               ...
               if (x > 0){
                    ...
                    if(resultado.length == 3){
                        ...
                        Item item = new Item(x,Integer.valueOf(p1),Integer.valueOf(p2),1);
                        itens.add(item);
                        listPedidos.add(item);                 
                    }
              }
    ...
    public static boolean PodeAlocar(Item p, float w, float h){
    ...
    public static boolean RotacaoItem(Item i, float w, float h){
    ...
    public static Faixas CriaFh(Item p, float w, float h, int o, Ponto pIfE, Ponto pSD){
    ...
    public static Faixas CriaFv(Item p, float w, float h, int o, Ponto pIfE, Ponto pSD ){//
    ...
    public static void AlocarItemFh(Item p, Faixas f, List<Item> Fhi, StringResultado sh, String t, Faixas fh_aux,
       ...
       for (int i = 0; i < p.getD();i++ ){
            ...
            if (FuncoesGrasp.PodeAlocar(p, f.getRw(), f.getRh())){
                ...
                if(f.getO() == 0){
                    ...
                    Peca peca_Ser_Cortada = new Peca(pedac, p, false, true);
...
//**                            + "\tPontSupDir("+peca_Ser_Cortada.getPontoSupDir().getX()+","+peca_Ser_Cortada.getPontoSupDir().getY()+")");
		    ...
		    Corte corte2 = new Corte();
                    ...
                    if((peca_Ser_Cortada.getPontoSupDir().getY() == f.getPontoSuperiorDireito().getY()) && 
                        ...
                        cntCortH = cntCortH + 1;
                        /*corte1.registraCorte(peca_Ser_Cortada.retornaBase(), new Ponto(peca_Ser_Cortada.getPontoSupDir().getX(),
                                                                                                 peca_Ser_Cortada.getPontoInfEsq().getY()), true, 
                                                                                                 peca_Ser_Cortada.retornaAltura(),
                                                                                                 l_corte.size()+1); */ 
                        corte1.registraCorte(peca_Ser_Cortada.retornaBase(), new Ponto(peca_Ser_Cortada.getPontoInfEsq()), true, 
                                                                                                 peca_Ser_Cortada.retornaAltura(),
                                                                                                 l_corte.size()+1); 
                        corte1.setPontoChapaCortadaGrasp(new Ponto(peca_Ser_Cortada.getPontoInfEsq()));
                        corte1.setPosicaoCorteGrasp(peca_Ser_Cortada.retornaBase());
...
//*                                  sobra1.getPontoSuperiorDireito().getY()+")");
                        ...
                        /*corte1.registraCorte(peca_Ser_Cortada.retornaAltura(), new Ponto(peca_Ser_Cortada.getPontoInfEsq().getX(),
                        ...
                        //retornaBase()
                        corte1.registraCorte(peca_Ser_Cortada.retornaAltura(), new Ponto(peca_Ser_Cortada.getPontoInfEsq()),//peca_Ser_Cortada.getPontoInfEsq().getY() + p.getH()),
                                                                                        false, peca_Ser_Cortada.retornaBase(), l_corte.size()+1);
                        corte1.setPontoChapaCortadaGrasp(new Ponto(peca_Ser_Cortada.getPontoInfEsq()));
                        corte1.setPosicaoCorteGrasp(peca_Ser_Cortada.retornaAltura());
...
//*                                  sobra1.getPontoSuperiorDireito().getY()+")");
                        ...
                        if((peca_Ser_Cortada.getPontoSupDir().getX() == f.getPontoSuperiorDireito().getX()) &&
                           ...
                           //           sobra1.getPontoSuperiorDireito().getY()+")");
                            ...
                            cntCortH = cntCortH + 1;
                          //corte1.registraCorte(peca_Ser_Cortada.retornaBase(),pife,true, f.getH(), l_corte.size()+1); //Altura da faixa                          
                            corte1.registraCorte(peca_Ser_Cortada.retornaBase(),new Ponto(peca_Ser_Cortada.getPontoInfEsq()),true,
                                                                                                        f.getH(), l_corte.size()+1);
                            corte1.setPontoChapaCortadaGrasp(new Ponto(peca_Ser_Cortada.getPontoInfEsq()));
                            corte1.setPosicaoCorteGrasp(peca_Ser_Cortada.retornaBase());
...
//*                                      sobra1.getPontoSuperiorDireito().getY()+")");
                            ...
                            pife = new Ponto(peca_Ser_Cortada.getPontoInfEsq().getX(), peca_Ser_Cortada.getPontoSupDir().getY());
                                             //peca_Ser_Cortada.getPontoInfEsq().getY() + peca_Ser_Cortada.retornDimensoes().retorneAltura());

                            pisd = new Ponto(peca_Ser_Cortada.getPontoSupDir().getX(), f.getPontoSuperiorDireito().getY());

                            cntCortH = cntCortH + 1;

                            /*corte2.registraCorte(peca_Ser_Cortada.retornaAltura(),
                                                                pife, false, peca_Ser_Cortada.retornaBase(), l_corte.size()+1);*/
                            corte2.registraCorte(peca_Ser_Cortada.retornaAltura(), new Ponto(peca_Ser_Cortada.getPontoInfEsq()),
                                                                                false, peca_Ser_Cortada.retornaBase(), l_corte.size()+1);
                            corte2.setPontoChapaCortadaGrasp(new Ponto(peca_Ser_Cortada.getPontoInfEsq()));
                            corte2.setPosicaoCorteGrasp(peca_Ser_Cortada.retornaAltura());
...
//*                                      sobra2.getPontoSuperiorDireito().getY()+")");
                    ...
                    Peca peca_Ser_Cortada = new Peca(pedac, p, true,true);
		    ...
		    Corte corte2 = new Corte();
                    ...
                    if((peca_Ser_Cortada.getPontoSupDir().getY() == f.getPontoSuperiorDireito().getY()) && 
                        ...
                        /*corte1.registraCorte(peca_Ser_Cortada.retornaBase(), new Ponto(peca_Ser_Cortada.getPontoSupDir().getX(),
                                                                                ...
                                                                                l_peca.size()+1);*/
                        corte1.registraCorte(peca_Ser_Cortada.retornaBase(), new Ponto(peca_Ser_Cortada.getPontoInfEsq()), true,
                                                                                peca_Ser_Cortada.retornaAltura(), l_peca.size()+1);
                        corte1.setPontoChapaCortadaGrasp(new Ponto(peca_Ser_Cortada.getPontoInfEsq()));
                        corte1.setPosicaoCorteGrasp(peca_Ser_Cortada.retornaBase());
...
//*                                  sobra1.getPontoSuperiorDireito().getY()+")");
                        ...
                        if((peca_Ser_Cortada.getPontoSupDir().getX() == f.getPontoSuperiorDireito().getX()) &&
                           ...
                           //           sobra1.getPontoSuperiorDireito().getY()+")");
                            ...
                            cntCortH = cntCortH + 1;
                          //corte1.registraCorte(peca_Ser_Cortada.retornaBase(), pife, true,f.getH(), l_corte.size()+1); //Altura da faixa
                            corte1.registraCorte(peca_Ser_Cortada.retornaBase(), new Ponto(peca_Ser_Cortada.getPontoInfEsq()), true,f.getH(),
                                                                                                                                l_corte.size()+1);
                            corte1.setPontoChapaCortadaGrasp(new Ponto(peca_Ser_Cortada.getPontoInfEsq()));
                            corte1.setPosicaoCorteGrasp(peca_Ser_Cortada.retornaBase());
...
//*                                      sobra1.getPontoSuperiorDireito().getY()+")");
                            ...
                            /*corte2.registraCorte(peca_Ser_Cortada.retornaAltura(),
                                                                                ...
                                                                                l_corte.size()+1);*/
                            corte2.registraCorte(peca_Ser_Cortada.retornaAltura(), new Ponto(peca_Ser_Cortada.getPontoInfEsq()), false, 
...
//**                            + "\tPontSupDir("+peca_Ser_Cortada.getPontoSupDir().getX()+","+peca_Ser_Cortada.getPontoSupDir().getY()+")");
		    ...
		    Corte corte2 = new Corte();
                    ...
                    if((peca_Ser_Cortada.getPontoSupDir().getX() == f.getPontoSuperiorDireito().getX()) && 
                        ...
                        cntCortV = cntCortV + 1;
                        /*corte1.registraCorte(peca_Ser_Cortada.retornaAltura(),pife, false, 
                                                                                peca_Ser_Cortada.retornaBase(),
                                                                                l_corte.size()+1);*/
                       corte1.registraCorte(peca_Ser_Cortada.retornaAltura(),new Ponto(peca_Ser_Cortada.getPontoInfEsq()), false, 
                                                                                                    peca_Ser_Cortada.retornaBase(),
                                                                                                    l_corte.size()+1);
                       corte1.setPontoChapaCortadaGrasp(new Ponto(peca_Ser_Cortada.getPontoInfEsq()));
                       corte1.setPosicaoCorteGrasp(peca_Ser_Cortada.retornaAltura());
...
//*                                  sobra1.getPontoSuperiorDireito().getY()+")");
                       ...
                       /*corte1.registraCorte(peca_Ser_Cortada.retornaBase(), new Ponto(peca_Ser_Cortada.getPontoSupDir().getX(),
                                                                               peca_Ser_Cortada.getPontoInfEsq().getY()), true,
                                                                               peca_Ser_Cortada.retornaAltura(), l_corte.size()+1);*/
                       //retornaAltura()
                       corte1.registraCorte(peca_Ser_Cortada.retornaBase(), new Ponto(peca_Ser_Cortada.getPontoInfEsq()), true,
                                                                               peca_Ser_Cortada.retornaAltura(), l_corte.size()+1);
...
//*                                  sobra1.getPontoSuperiorDireito().getY()+")");
                       ...
                       if((peca_Ser_Cortada.getPontoSupDir().getX() == f.getPontoSuperiorDireito().getX()) &&
                           ...
                           cntCortV = cntCortV + 1;
                           //corte1.registraCorte(peca_Ser_Cortada.retornaAltura(), pife, false,f.getW(), l_corte.size()+1); //Altura da faixa
                           corte1.registraCorte(peca_Ser_Cortada.retornaAltura(), new Ponto(peca_Ser_Cortada.getPontoInfEsq()), false,
                                                                                                            f.getW(), l_corte.size()+1); 
...
//*                                      sobra1.getPontoSuperiorDireito().getY()+")");
                           ...
                           cntCortV = cntCortV + 1;
                           /*corte2.registraCorte(peca_Ser_Cortada.retornaBase(),
                           ...
                           corte2.registraCorte(peca_Ser_Cortada.retornaBase(), new Ponto(peca_Ser_Cortada.getPontoInfEsq()), true, 
                                                                                            peca_Ser_Cortada.retornaAltura(), l_corte.size()+1);
                           corte2.setPontoChapaCortadaGrasp(new Ponto(peca_Ser_Cortada.getPontoInfEsq()));
                           corte2.setPosicaoCorteGrasp(peca_Ser_Cortada.retornaBase());
...
//                                        + " SupDireito ("+f.getPontSupDRh().getX()+","+f.getPontSupDRh().getY() +")");                    
    ...
    public static List<Item> CriaBh(List<Item> Lc, List<Item> Bh, float w, float h,Item p){
        ...
        for(int i = 0;i< Lc.size();i++){
            ...
            //if(FuncoesGrasp.PodeAlocar(Item, w, h) ){
    ...
    public static List<Item> CriaBv(List<Item> Lc, List<Item> Bv, float w, float h,Item p){
    ...
    public static List<Item> MelhoreFh(Faixas Fh, List<Item> Bh ,Item item, List<Item> Fhi, StringResultado sh, Faixas fh_aux,
        ...
        if (!FuncoesGrasp.PodeAlocar(item, Fh.getRw(),Fh.getRh()) || item.getD() == 0){
            //System.out.println("Nao alocou Id->"+Item.getId()+" WxH->"+Item.getW()+"x"+Item.getH()+" V->"+Item.getV()+"Rfh x Rfw"+r.getW()+"x"+r.getH());
            Bh.remove(item);
            return Bh;
        }
        
        if (FuncoesGrasp.RotacaoItem(item, Fh.getRw(),Fh.getH())){
        ...
        FuncoesGrasp.AlocarItemFh(item, Fh, Fhi,sh,"M",fh_aux, l_corte, l_peca,l_sobra, pSD,list_sobra);
        Bh.remove(item);
    ...
    public static List<Item> MelhoreFv(Faixas Fv,List<Item> Bv ,Item item,List<Item> Fvi, StringResultado sv, Faixas fv_aux,
        ...
        if (!FuncoesGrasp.PodeAlocar(item, Fv.getRw(), Fv.getRh()) || item.getD() == 0){
        //if (!FuncoesGrasp.PodeAlocar(item, Fv.getW(), Fv.getH()) || item.getD() == 0){
            Bv.remove(item);
            return Bv;
        }
        if (FuncoesGrasp.RotacaoItem(item, Fv.getRw(), Fv.getRh())){
        //if (FuncoesGrasp.RotacaoItem(item, Fv.getW(), Fv.getH())){
            Fv.setO(1);
            //System.out.println("Alocou Rotacionado Id->"+Item.getId()+" WxH->"+Item.getW()+"x"+Item.getH()+" V->"+Item.getV());
        }else{
            Fv.setO(0);
        ...
        FuncoesGrasp.AlocarItemFv(item, Fv, Fvi,sv,"M", fv_aux, l_corte, l_peca, l_sobra, pSD,list_sobra);
        Bv.remove(item);
        
        return Bv;
    }

    public static List<Item> AtualizaC(List<Item> item, List<Item> c, Bin S){
        ...
        for(int i = 0;i < item.size();i++ ){
            ...
            j = FuncoesGrasp.CriaItem(j, item.get(i));
    ...
    public static List<Item> AtualizaC2(List<Item> item, List<Item> c, Bin Chapa, List<Item> lc, float w, float h, 
        ...
        try{        
            ...
            for(int i = 0;i < item.size();i++ ){
                ...
                j.setD(j.getD() - q);
                //System.out.println("Demanda item --> "+ j.getD());
                
                Chapa.setFav(Chapa.getFav()+j.getV());
                Chapa.setSobra(Chapa.retorneDimensao().retorneArea() - Chapa.getFav());
                
                for (int x = 0; x < c.size();x++){
                    
                    if(j.getId() == c.get(x).getId()){
                    
                        //System.out.println("Item encontrado j_id --> "+j.getId());
    ...
    public static List<Item> AtualizaC3(List<Item> item, List<Item> c, Bin S, List<Item> lc, int w, int h){
    ...
    public static void ImprimeSolucao(List<Bin> Solucao){
        ...
        for(int i = 0; i < Solucao.size(); i++){
            ...
            for(int j = 0; j < f.size(); j++){
                ...
                FuncoesGrasp.ImprimeItens("Itens", f.get(j).getItem());
            }
        }
    }

    public static Heuristicas.Solucao ConvertSolucao(List<Bin> Solucao, LinkedList<HHDInterfaces.IPedido> lPedidos, IDimensao2d tamanho){

        SolucaoHeuristica solucaoHeuristica = new SolucaoHeuristica(tamanho, lPedidos);
    ...
    public static void ordenaSolucaoCrescente(SolucaoHeuristica solucao){
    
        Collections.sort(solucao.getObjetos(), new ComparadorPlacaIBin());
    }
    
    public static void ordenaSolucaoDecrescente(SolucaoHeuristica solucao){
    
        Collections.sort(solucao.getObjetos(), new ComparadorPlacaIBin());
        Collections.reverse(solucao.getObjetos());
    }
    
    //MÉTODOS NECESSÁRIOS PARA O GRASP MELHORIA
    public static ArrayList<Item> convertIpedidoItem(LinkedList<IPedido> lPedidos){
    
        ArrayList<Item> array_item = new ArrayList<Item>();
        
        Iterator<IPedido> iter = lPedidos.iterator();
        
        while(iter.hasNext()){
        
            IPedido p = iter.next();
        
            if(p.quantidade() > 1){//Tratar quando a demanda for zerooooooo !!!
                array_item.add(new Item(p.id(), p.retorneDimensao().retorneBase(), p.retorneDimensao().retorneAltura(), 1));
            }
            else
                array_item.add(new Item(p.id(), p.retorneDimensao().retorneBase(), p.retorneDimensao().retorneAltura(), p.quantidade()));
        }
    
        return array_item;    
    }
    
    public static LinkedList<IPedido> algoritmo_desmonteGRASP(IBin bin_escolhida){
        ...
        while(iter_peca.hasNext()){
            ...
            //System.out.println("Quantidade do pedido  --> "+  pedido.quantidade());
            //Devolve o pedido
            //pedido.devolvaPedido();
            //System.out.println("Quantidade após devolver pedido  --> "+pedido.quantidade());
//            System.out.println("Pedidos Id: "+pedido.id()+" L x A -> "+pedido.retorneDimensao().retorneBase()+
//                                                                  " , "+pedido.retorneDimensao().retorneAltura());
    ...
    //ESSE MÉTODO É RESPONSÁVEL POR RECEBER UMA SOLUÇÃO PARCIAL DO GRASP E ACOPLAR AS DUAS SOLUÇÕES
    public static SolucaoHeuristica acoplaSolucao(SolucaoHeuristica anterior, SolucaoHeuristica sol_nova){
    
        //List<Bin> listObj = anterior.getObjetos();
        //listObj.addAll(sol_nova.getObjetos());  //Acopla as novas placas
        anterior.getObjetos().addAll(sol_nova.getObjetos());
        anterior.getIPedidos().addAll(sol_nova.getIPedidos()); //Acopla os pedidos atendidos
        anterior.set_Fav(anterior.get_Fav() + sol_nova.get_Fav());
        /*
        int cont = 0, qtPlaca = listObj.size();
        float w = anterior.getTamanhoChapa().retorneBase();
        float h = anterior.getTamanhoChapa().retorneAltura();
        Double FAV = 0.0, FAV2 = 0.0, sobra, MenorAp = 0.0;
        
        Iterator<Bin> itObj = listObj.iterator();
        //Calcular o FAV e FAV2
        while(itObj.hasNext()){
        
            Bin obj = itObj.next();
            FAV = FAV + obj.getFav();
            
            sobra = 100-(obj.getFav()/(w*h)*100);
        ...
        FAV = FAV/(qtPlaca*w*h);
        FAV2 =((FAV*100)+MenorAp)/qtPlaca;
        
        anterior.setFAV(FAV);
        anterior.setFAV2(FAV2);
        */
        return anterior;
    }
